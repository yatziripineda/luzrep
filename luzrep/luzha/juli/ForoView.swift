...
struct ForoView: View {
    ...
    @State private var posts: [ForoPost] = [
        ForoPost(author: "Juli", title: "Mi primera publicación", body: "¡Hola a todos! Este es mi primer post.", likes: 0, comments: []),
        ...
        ForoPost(author: "Pedro", title: "Noticias del día", body: "¡Hoy es un gran día! .", likes: 1, comments: []),
    ]
